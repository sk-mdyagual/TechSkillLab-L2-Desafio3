package co.com.techskill.lab2.library.service.impl.dummy;

import co.com.techskill.lab2.library.domain.dto.PetitionDTO;
import co.com.techskill.lab2.library.domain.entity.Petition;
import co.com.techskill.lab2.library.service.IPetitionServiceDummy;
...
@Service
public class PetitionService implements IPetitionServiceDummy {
    ...
    public PetitionService() {
        ...
        petitions.add(new PetitionDTO("ad4801f0-9", "INSPECT", 7, "51ed516f-a", LocalDate.parse("2025-07-25")));
        ...
        petitions.add(new PetitionDTO("905dfc53-7", "INSPECT", 7, "6600ab76-3", LocalDate.parse("2025-07-25")));
        ...
        petitions.add(new PetitionDTO("2da99667-d", "INSPECT", 7, "1940136a-2", LocalDate.parse("2025-07-25")));
